...
import { PartialStatusObject } from '.pnpm/@grpc+grpc-js@1.10.8/node_modules/@grpc/grpc-js/build/src/call-interface';
...
import { SocketRef } from '.pnpm/@grpc+grpc-js@1.10.8/node_modules/@grpc/grpc-js/build/src/channelz';
...
import { Http2SubchannelCall, SubchannelCall, SubchannelCallInterceptingListener } from '.pnpm/@grpc+grpc-js@1.10.8/node_modules/@grpc/grpc-js/build/src/subchannel-call';
