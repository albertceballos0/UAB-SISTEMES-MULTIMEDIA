...
import { ClientDuplexStream, ClientReadableStream, ClientUnaryCall, ClientWritableStream, ServiceError, SurfaceCall } from '.pnpm/@grpc+grpc-js@1.10.8/node_modules/@grpc/grpc-js/build/src/call';
import { CallCredentials } from '.pnpm/@grpc+grpc-js@1.10.8/node_modules/@grpc/grpc-js/build/src/call-credentials';
import { Channel } from '.pnpm/@grpc+grpc-js@1.10.8/node_modules/@grpc/grpc-js/build/src/channel';
...
import { ClientMethodDefinition } from '.pnpm/@grpc+grpc-js@1.10.8/node_modules/@grpc/grpc-js/build/src/make-client';
import { Interceptor, InterceptorProvider } from '.pnpm/@grpc+grpc-js@1.10.8/node_modules/@grpc/grpc-js/build/src/client-interceptors';
import { ServerUnaryCall, ServerReadableStream, ServerWritableStream, ServerDuplexStream } from '.pnpm/@grpc+grpc-js@1.10.8/node_modules/@grpc/grpc-js/build/src/server-call';
